...
Public Const FIELD_EXT_TIMESTAMP = "ext_timestamp"
...
Public Const TABLE_USER_CHANGE_LOG = "user_change_log"
...
Public Const KEY_ENABLE_LDAP = "enableLDAP"
...
Public Const FILE_EXTENSION_TEMPLATE_MAPPING = ".xlsxm"
